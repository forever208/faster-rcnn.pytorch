...
class coco(imdb):
    def __init__(self, image_set, year):
        ...
        # Dataset splits that have ground-truth annotations (test splits do not have gt annotations)
    ...
    def image_path_from_index(self, index):
        ...
        """
        # image path, e.g. index=119993: ./images/train2014/COCO_train2014_000000119993.jpg
